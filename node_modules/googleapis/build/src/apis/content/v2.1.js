...
(function (content_v2_1) {
    ...
    class Resource$Accountstatusesbyexternalsellerid {
        constructor(context) {
            this.context = context;
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/content/v2.1/{merchantId}/accountstatusesbyexternalsellerid/{externalSellerId}').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                }, options),
                params,
    ...
    content_v2_1.Resource$Accountstatusesbyexternalsellerid = Resource$Accountstatusesbyexternalsellerid;
