...
export declare namespace youtube_v3 {
    ...
    export class Resource$Youtube$V3$Livebroadcasts$Cuepoint {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Youtube$V3$Livebroadcasts$Cuepoint$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Youtube$V3$Livebroadcasts$Cuepoint$Create, options?: MethodOptions): GaxiosPromise<Schema$Cuepoint>;
        create(params: Params$Resource$Youtube$V3$Livebroadcasts$Cuepoint$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Youtube$V3$Livebroadcasts$Cuepoint$Create, options: MethodOptions | BodyResponseCallback<Schema$Cuepoint>, callback: BodyResponseCallback<Schema$Cuepoint>): void;
        create(params: Params$Resource$Youtube$V3$Livebroadcasts$Cuepoint$Create, callback: BodyResponseCallback<Schema$Cuepoint>): void;
        create(callback: BodyResponseCallback<Schema$Cuepoint>): void;
    }
    export interface Params$Resource$Youtube$V3$Livebroadcasts$Cuepoint$Create extends StandardParameters {
        /**
         * Broadcast to insert ads to, or equivalently `external_video_id` for internal use.
         */
        id?: string;
